...
#if defined(CONFIG_BOARD_OBELIX)
    {.key = FONT_KEY_CHIKAREGO_16, .handle = RESOURCE_ID_CHIKAREGO_16},
    {.key = FONT_KEY_CHIKAREGO_32, .handle = RESOURCE_ID_CHIKAREGO_32},
    {.key = FONT_KEY_CHIKAREGO_48, .handle = RESOURCE_ID_CHIKAREGO_48},
    {.key = FONT_KEY_PIXELVA_12, .handle = RESOURCE_ID_PIXELVA_12},
    {.key = FONT_KEY_PIXELVA_24, .handle = RESOURCE_ID_PIXELVA_24},
    {.key = FONT_KEY_PIXELVA_36, .handle = RESOURCE_ID_PIXELVA_36},
    {.key = FONT_KEY_COZETTE_13, .handle = RESOURCE_ID_COZETTE_13},
    {.key = FONT_KEY_COZETTE_26, .handle = RESOURCE_ID_COZETTE_26},
    {.key = FONT_KEY_COZETTE_39, .handle = RESOURCE_ID_COZETTE_39},
#endif
#if defined(CONFIG_BOARD_OBELIX) || defined(CONFIG_BOARD_GETAFIX)
