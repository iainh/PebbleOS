...
// Retained as the reference implementation for differential tests and benchmarks.
void bitblt_bitmap_into_bitmap_tiled_palette_to_1bit_c(GBitmap *dest_bitmap,
                                                       const GBitmap *src_bitmap, GRect dest_rect,
                                                       GPoint src_origin_offset,
                                                       GCompOp compositing_mode, GColor tint_color);

void bitblt_bitmap_into_bitmap_tiled_palette_to_8bit(
...
// Reference implementations retained for fallback, differential tests, and benchmarks.
void bitblt_bitmap_into_bitmap_tiled_8bit_to_8bit_c(
    GBitmap* dest_bitmap, const GBitmap* src_bitmap, GRect dest_rect,
    GPoint src_origin_offset, GCompOp compositing_mode, GColor8 tint_color);

void bitblt_bitmap_into_bitmap_tiled_palette_to_8bit_c(
    GBitmap* dest_bitmap, const GBitmap* src_bitmap, GRect dest_rect,
    GPoint src_origin_offset, GCompOp compositing_mode, GColor8 tint_color);
